...
* **Google Antigravity & AI Models (Gemini, Claude Sonnet 4.6, Claude 3.7):** прямое подключение к европейскому шлюзу (Франкфурт), стабильная работа без региональных блокировок и ошибок подключения.
